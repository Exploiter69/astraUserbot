...
class RuntimeServiceTests(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_application_context_starts_and_closes_services(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(set(context.services), {"storage", "cache", "http", "subprocess", "telegram_state", "telegram", "telegram_event_journal", "telegram_events", "telegram_event_projections", "intelgraph", "workspace", "media", "jobs", "secrets", "ai", "search", "metrics", "flags", "isolation"})
            ...
            self.assertTrue(context.get("search")._ready); self.assertTrue(context.get("flags")._started); self.assertTrue(context.get("isolation")._started); self.assertTrue(context.get("telegram_state")._started); self.assertTrue(context.get("telegram_event_journal")._started); self.assertTrue(context.get("telegram_events")._started); self.assertTrue(context.get("telegram_event_projections")._started); self.assertTrue(context.get("intelgraph")._started)
