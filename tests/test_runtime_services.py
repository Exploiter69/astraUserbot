...
class RuntimeServiceTests(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_application_context_starts_and_closes_services(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(set(context.services), {"storage", "cache", "http", "subprocess", "telegram_state", "telegram", "telegram_event_journal", "telegram_events", "telegram_event_projections", "telegram_event_replay", "intelgraph", "workspace", "media", "jobs", "automation", "secrets", "ai", "search", "telegram_archive", "metrics", "flags", "isolation"})
